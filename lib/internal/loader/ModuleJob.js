...
class ModuleJob {
  ...
  constructor(loader, moduleProvider, url) {
    ...
    // linked == promise for dependency jobs, with module populated, module wrapper linked
    ...
    this.linked = (async() => {
      ...
      this.module.link(async dependencySpecifier => {
        const dependencyJobPromise = this.loader.getModuleJob(this, dependencySpecifier);
    ...
    // instantiated == deep dependency jobs wrappers instantiated, module wrapper instantiated
...
Object.setPrototypeOf(ModuleJob.prototype, Object.create(null));
